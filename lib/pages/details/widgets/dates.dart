...
class Dates extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for(int i=0;i<6;i++){
      dateBoxes.add(DateBox(date: date, active: i == 1,));
...
class DateBox extends StatelessWidget {
  ...
  final DateTime date;
  const DateBox({
    super.key, this.active=false, required this.date,
  });
      ...
      child: DefaultTextStyle.merge(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 8,),
            Text(date.day.toString().padLeft(2, '0'), style: TextStyle(fontSize: 27, fontWeight: FontWeight.w500),),
